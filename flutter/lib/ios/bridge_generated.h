...
void wire_init_vault_state(int64_t port_);

void wire_fetch_async(int64_t port_, uint64_t chain_id, struct wire_uint_8_list *account);

void wire_fetch_async2(int64_t port_, uint64_t chain_id, struct wire_uint_8_list *account);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_init_vault_state);
    dummy_var ^= ((int64_t) (void*) wire_fetch_async);
    dummy_var ^= ((int64_t) (void*) wire_fetch_async2);
